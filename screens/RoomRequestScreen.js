...
// ─── Screen Component ─────────────────────────────────────────────────────────
export default function RoomRequestScreen({ navigation }) {
  ...
  const handleRequest = () => {
    Alert.alert('Request Submitted', 'Room cleaning request submitted successfully!', [
          ...
          <View style={styles.serviceRow}>
            ...
            >
              <GlassPanel
                ...
                intensity={12}
              >
                <Text style={styles.serviceCardTitle}>Basic Room Cleaning</Text>
                <Text style={styles.serviceCardSubtitle}>{'Mopping , Dusting &\nBed tidy-up'}</Text>
              </GlassPanel>
            </TouchableOpacity>
            ...
            >
              <GlassPanel
                ...
                intensity={12}
              >
                <Text style={styles.serviceCardTitle}>Standard Room Cleaning</Text>
                <Text style={styles.serviceCardSubtitle}>{'Sweeping ,\nDusting &\nTrash Removal'}</Text>
              </GlassPanel>
            </TouchableOpacity>
          </View>
